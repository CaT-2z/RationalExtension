...
//        System.out.println(new ComplexBasisPart(c, Rational.HALF).getInverse());

//        ExtendedRational a = Utils.root(ExtendedRational.fromSimple(5,1), BigInteger.TWO).add(Rational.ONE);
//        System.out.println(a);
//        a = Utils.root(a, BigInteger.TWO).add(Rational.ONE);
//        System.out.println(a);
//
//        ComplexBasisPart b = new ComplexBasisPart(a, Rational.HALF);
//        ExtendedRational c = b.getInverse();
